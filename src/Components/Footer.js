        ...
        <footer className=" p-10 bg-base-200 text-base-content">
            <div className="footer">
                <div>
                    ...
                    <p>HALDA Industries Ltd. <br /> Providing reliable tech since 1992</p>
            ...
            <div>
                <p className='text-center pt-5'>Copyright © 2022 - All right reserved by HALDA Industries Ltd</p>
            </div>
        </footer>
    );
};
